...
// Work projects have no public repository, so `link` is optional: without it
// the card shows the same content but nothing is clickable.
  ...
  return (
    ...
    >
      ...
      {link ? (
        ...
        <div className="w-1/2 overflow-hidden rounded-lg lg:w-full">{cover}</div>
      )}
